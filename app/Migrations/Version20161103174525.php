...
class Version20161103174525 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE server_uses (server_id INT NOT NULL, serveruse_id INT NOT NULL, INDEX IDX_7114973F1844E6B7 (server_id), INDEX IDX_7114973FEB1E3248 (serveruse_id), PRIMARY KEY(server_id, serveruse_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE server_use (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, datetime DATETIME NOT NULL, UNIQUE INDEX UNIQ_AA78C611A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE server_uses ADD CONSTRAINT FK_7114973F1844E6B7 FOREIGN KEY (server_id) REFERENCES server (id)');
        $this->addSql('ALTER TABLE server_uses ADD CONSTRAINT FK_7114973FEB1E3248 FOREIGN KEY (serveruse_id) REFERENCES server_use (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE server ADD groups LONGTEXT NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:array)\', ADD author LONGTEXT NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:array)\'');
    }
}
